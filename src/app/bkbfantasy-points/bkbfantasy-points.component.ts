...
@Component({
  selector: 'app-bkbfantasy-points',
  templateUrl: './bkbfantasy-points.component.html',
  styleUrls: ['./bkbfantasy-points.component.scss']
})
export class BkbfantasyPointsComponent {


  base = 'bkbfantasy-points';
  data = [];
  types = [];
  tab;
  roleid :any;
