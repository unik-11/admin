...
@Component({
  selector: 'app-bkbearning-manager',
  templateUrl: './bkbearning-manager.component.html',
  styleUrls: ['./bkbearning-manager.component.scss']
})
export class BkbearningManagerComponent implements OnInit {


  base = 'bkbearning-manager';
  competition=[];
  search = '';
  page = 0;
  perPage=0;
