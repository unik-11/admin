...
import { BkbfixturesRoutingModule } from './bkbfixtures-routing.module';
...
@NgModule({
  declarations: [BkbfixturesComponent, ViewcronComponent, AllViewcronComponent],
  imports: [
    CommonModule,
    BkbfixturesRoutingModule,
    MatToolbarModule,
    MatIconModule,
    MatChipsModule,
    FormsModule,
...
export class BkbfixturesModule { }
