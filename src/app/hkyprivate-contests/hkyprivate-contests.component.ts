...
@Component({
  selector: 'app-hkyprivate-contests',
  templateUrl: './hkyprivate-contests.component.html',
  styleUrls: ['./hkyprivate-contests.component.scss']
})
export class HkyprivateContestsComponent implements OnInit {


  base = 'hkyprivate-contests';
  data = [];
