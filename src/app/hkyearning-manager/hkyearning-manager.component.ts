...
@Component({
  selector: 'app-hkyearning-manager',
  templateUrl: './hkyearning-manager.component.html',
  styleUrls: ['./hkyearning-manager.component.scss']
})
export class HkyearningManagerComponent implements OnInit {


  base = 'hkyearning-manager';
  competition=[];
  search = '';
  page = 0;
  perPage=0;
