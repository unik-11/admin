...
@Component({
  selector: 'app-bsbcontests',
  templateUrl: './bsbcontests.component.html',
  styleUrls: ['./bsbcontests.component.scss']
})
export class BsbcontestsComponent implements OnInit {
  ...
  async generatedPdf(d) {
    ...
    if (value) {
      ...
      const v: any = await this.api.get('bsbgeneratepdf/' + d.id).toPromise();
