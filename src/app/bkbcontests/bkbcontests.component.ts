...
@Component({
  selector: 'app-bkbcontests',
  templateUrl: './bkbcontests.component.html',
  styleUrls: ['./bkbcontests.component.scss']
})
export class BkbcontestsComponent implements OnInit {
  ...
  async generatedPdf(d) {
    ...
    if (value) {
      ...
      const v: any = await this.api.get('bkbgeneratepdf/' + d.id).toPromise();
