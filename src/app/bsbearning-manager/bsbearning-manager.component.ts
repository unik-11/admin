...
@Component({
  selector: 'app-bsbearning-manager',
  templateUrl: './bsbearning-manager.component.html',
  styleUrls: ['./bsbearning-manager.component.scss']
})
export class BsbearningManagerComponent implements OnInit {


  base = 'bsbearning-manager';
  competition=[];
  search = '';
  page = 0;
  perPage=0;
