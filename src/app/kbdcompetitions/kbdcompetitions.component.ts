...
@Component({
  ...
  templateUrl: './kbdcompetitions.component.html',
  styleUrls: ['./kbdcompetitions.component.scss']
})
export class KbdcompetitionsComponent {
  fields: FormlyFieldConfig[] = [];
  base = 'kbdcompetitions';
  data = [];
  total = 0;
  page = 0;
  search = '';
