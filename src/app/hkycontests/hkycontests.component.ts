...
@Component({
  selector: 'app-hkycontests',
  templateUrl: './hkycontests.component.html',
  styleUrls: ['./hkycontests.component.scss']
})
export class HkycontestsComponent implements OnInit {
