...
@Component({
  selector: 'app-hkycompetitions',
  templateUrl: './hkycompetitions.component.html',
  styleUrls: ['./hkycompetitions.component.scss']
})
export class HkycompetitionsComponent {

  fields: FormlyFieldConfig[] = [];
  base = 'hkycompetitions';
  data = [];
  total = 0;
  page = 0;
  search = '';
  ...
  async setParams() {
    ...
    this.init()
    //await this.router.navigate(['/ftb_competitions'], { queryParams: params });
  }
