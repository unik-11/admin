...
@Component({
  selector: 'app-hkyleaderboard',
  templateUrl: './hkyleaderboard.component.html',
  styleUrls: ['./hkyleaderboard.component.scss']
})
export class HkyleaderboardComponent implements OnInit {
