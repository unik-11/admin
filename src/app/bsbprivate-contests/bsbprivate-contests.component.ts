...
@Component({
  selector: 'app-bsbprivate-contests',
  templateUrl: './bsbprivate-contests.component.html',
  styleUrls: ['./bsbprivate-contests.component.scss']
})
export class BsbprivateContestsComponent implements OnInit {
