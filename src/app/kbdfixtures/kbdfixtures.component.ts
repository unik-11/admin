  ...
  @Component({
    selector: 'app-kbdfixtures',
  templateUrl: './kbdfixtures.component.html',
  styleUrls: ['./kbdfixtures.component.scss']
  })
  export class KbdfixturesComponent {
    base = 'kbdfixtures';
