...
@Component({
  ...
  templateUrl: './kbdprivate-contests.component.html',
  styleUrls: ['./kbdprivate-contests.component.scss']
})
export class KbdprivateContestsComponent implements OnInit {

  base = 'kbdprivate-contests';
  data = [];
