...
@Component({
  selector: 'app-bkbprivate-contests',
  templateUrl: './bkbprivate-contests.component.html',
  styleUrls: ['./bkbprivate-contests.component.scss']
})
export class BkbprivateContestsComponent implements OnInit {


  base = 'bkbprivate-contests';
  data = [];
