...
@Component({
  selector: 'app-bsbcompetitions',
  templateUrl: './bsbcompetitions.component.html',
  styleUrls: ['./bsbcompetitions.component.scss']
})
export class BsbcompetitionsComponent {

  fields: FormlyFieldConfig[] = [];
    base = 'bsbcompetitions';
    data = [];
    total = 0;
    page = 0;
    search = '';
