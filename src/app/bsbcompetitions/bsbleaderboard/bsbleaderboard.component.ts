...
@Component({
  selector: 'app-bsbleaderboard',
  templateUrl: './bsbleaderboard.component.html',
  styleUrls: ['./bsbleaderboard.component.scss']
})
export class BsbleaderboardComponent implements OnInit {
