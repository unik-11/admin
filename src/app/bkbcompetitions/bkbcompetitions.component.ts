  ...
  @Component({
    selector: 'app-bkbcompetitions',
  templateUrl: './bkbcompetitions.component.html',
  styleUrls: ['./bkbcompetitions.component.scss']
  })
  export class BkbcompetitionsComponent {
    fields: FormlyFieldConfig[] = [];
    base = 'bkbcompetitions';
    data = [];
    total = 0;
    page = 0;
    search = '';
