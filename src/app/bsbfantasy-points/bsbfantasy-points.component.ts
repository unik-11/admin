...
@Component({
  selector: 'app-bsbfantasy-points',
  templateUrl: './bsbfantasy-points.component.html',
  styleUrls: ['./bsbfantasy-points.component.scss']
})
export class BsbfantasyPointsComponent  {


  base = 'bsbfantasy-points';
  data = [];
  types = [];
  tab;
  roleid :any;
