  ...
  @Component({
    selector: 'app-kbdleaderboard',
    templateUrl: './kbdleaderboard.component.html',
    styleUrls: ['./kbdleaderboard.component.scss']
  })
  export class KbdleaderboardComponent implements OnInit {
    base='kbdleaderboard';
    checked = true;
    page = 0;
    search = '';
    ...
    async setParams() {
      ...
      await this.router.navigate(['/kbdleaderboard/'+this.competitionId+"/"], { queryParams: params });
      await this.init();
    ...
    async exportData() {
      ...
      if (newValue) {
        ...
        const value = await this.api.get('kbdexport-leaderboard-data', { params, responseType: 'blob' }).toPromise();
        //console.log(value);
