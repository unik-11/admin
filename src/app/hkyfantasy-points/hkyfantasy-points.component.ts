...
@Component({
  selector: 'app-hkyfantasy-points',
  templateUrl: './hkyfantasy-points.component.html',
  styleUrls: ['./hkyfantasy-points.component.scss']
})
export class HkyfantasyPointsComponent  {


  base = 'hkyfantasy-points';
  data = [];
  types = [];
  tab;
  roleid :any;
